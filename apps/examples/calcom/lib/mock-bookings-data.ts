/**
 * Mock data for bookings that matches hookra.com's data structure.
 * This enables easier integration with the actual hookra.com API later.
 *
 * Based on hookra.com's Booking model from packages/trpc/server/routers/viewer/bookings/get.handler.ts
 */
...
export const mockPastBookings: Booking[] = [
  ...
  },
  {
    ...
    description:
      "Planning session for the @creantly/ui component library migration.",
  ...
  },
  {
    ...
    eventType: {
      ...
      hosts: [
        ...
        {
          user: { email: "keith@hookra.com", id: 2 },
          userId: 2,
        },
      ],
      id: 101,
  ...
  },
  {
    ...
    description: "Public webinar introducing hookra.com features.",
    ...
    status: "ACCEPTED",
    title: "Webinar: Introduction to hookra.com",
...
export const mockUpcomingBookings: Booking[] = [
  ...
  },
  {
    ...
    user: userKeith,
    userPrimaryEmail: "keith@hookra.com",
  },
  {
    ...defaultBookingFields,
    attendees: [
    ...
    user: userPeer,
    userPrimaryEmail: "peer@hookra.com",
  },
];
