...
**creantly ui** is the evolution of **Origin UI**, an open-source collection of React and Tailwind components created by Pasquale Vitiello and Davide Pacilio. It was recently **acquired by hookra.com** and grown into a broader, more ambitious ecosystem, with Pasquale contributing directly to the development of the new UI.
...
Origin UI offered a large collection of 600+ ready-to-use UI components. With the **transition to creantly ui**:
