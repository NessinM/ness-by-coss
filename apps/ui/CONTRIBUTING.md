...
Thank you for your interest in contributing to ness ui! This guide will help you understand how to contribute components and particles to our design system.

## Overview

**ness ui** consists of two main types of components:
...
// registry/registry-particles.ts
{
  ...
  name: "p-button-8",
  registryDependencies: ["@ness/button"],
  type: "registry:block",
}
```
...
- `registryDependencies`: Array of UI components used (e.g., `["@ness/button"]`, `["@ness/input", "@ness/label"]`)
...
- `registryDependencies` should reference `@ness/*` package names
...
Thank you for contributing to ness ui! 🎉
